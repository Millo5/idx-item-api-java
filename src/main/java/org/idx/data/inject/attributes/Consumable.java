...
public class Consumable {
    ...
    public static void inject() {
        ...
        Main.dataManager.addItem(new AttributeItem("edible", "Edible", "cooked_beef", AttributeType.ATTRIBUTE)
                .setDescription("Causes the item to disappear when eaten.")
                .addComponent(new TriggersComponent(
                        Trigger.EAT
                ))
        );
        Main.dataManager.addItem(new AttributeItem("drinkable", "Drinkable", "potion", AttributeType.ATTRIBUTE)
                .setDescription("Causes the item to disappear when eaten, leaving a glass bottle.")
                .addComponent(new TriggersComponent(
                        Trigger.EAT
                ))
        );
        Main.dataManager.addItem(new AttributeItem("consumable", "Consumable", "structure_void", AttributeType.ATTRIBUTE)
