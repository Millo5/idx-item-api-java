...
public class Weapons extends DataInjector {

    public static void melee() {

        // Common
        {
            addItem(new Item("old-wooden-sword", "Old Wooden Sword", "wooden_sword", ItemType.MELEE_WEAPON)
            ...
            addItem(new Item("polished-wooden-sword", "Polished Wooden Sword", "wooden_sword", ItemType.MELEE_WEAPON)
            ...
            addItem(new Item("sharpened-wooden-sword", "Sharpened Wooden Sword", "wooden_sword", ItemType.MELEE_WEAPON)
        ...
        // Uncommon
        {
            addItem(new Item("wooden-shiv", "Wooden Shiv", "wooden_sword", ItemType.MELEE_WEAPON)
            ...
            addItem(new Item("wooden-spear", "Wooden Spear", Resource.SPEAR, ItemType.MELEE_WEAPON)
        ...
        // Rare
        {
            addItem(new Item("throwing-axe", "Throwing Axe", "stone_axe", ItemType.MELEE_WEAPON)
        ...
        // Developer
        {
            addItem(new Item("clydes-blade", "Clyde's Blade", Resource.GREAT_SWORD, ItemType.MELEE_WEAPON)
    ...
    public static void ranged() {
        ...
        // Common
        {
            addItem(new Item("simple-bow", "Simple Bow", "bow", ItemType.RANGED_WEAPON)
        ...
        // Rare
        {
            addItem(new Item("longbow", "Longbow", "bow", ItemType.RANGED_WEAPON)
